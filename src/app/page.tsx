...
import { Users, Sparkles, Heart, LogIn, Settings, Camera } from "lucide-react";
      ...
      <nav className="container mx-auto px-4 py-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            ...
            <span className="text-xl font-bold text-foreground">Murray Creative</span>
          </div>
          <div className="flex items-center gap-2">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <section className="text-center bg-card p-12 rounded-2xl border shadow-sm">
          ...
          <p className="text-muted-foreground mb-8 max-w-2xl mx-auto">
            Discover our curated photo gallery or join our community to share your own creative work.
          </p>
